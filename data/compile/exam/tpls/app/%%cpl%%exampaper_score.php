...
<div id="main">
	...
	<div id="right_760" class="right_760">
    	...
    	<div class="bor_mid">
            ...
            <div id="result_con">
              ...
              <p class="mb_10">总分：<b class="orange"><?php echo $this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['score']; ?></b>分 合格分数线：<b class="orange"><?php echo $this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['passscore']; ?></b>分 答卷耗时：<b class="orange"><?php echo $this->tpl_var['sessionvars']['examsessiontime']; ?></b>分钟</p>
                  <table width="100%">
                          <tr>
                            <th>题型</th>
                            <th>总题数</th>
 ...
 $nid++; ?>
                          ...
                          <?php } ?>
                          <tr>
                            <td colspan="5" align="left">本次考试共<b class="orange"><?php echo $this->tpl_var['allnumber']; ?></b>道题，总分<b class="orange"><?php echo $this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['score']; ?></b>分，您做对<b class="orange"><?php echo $this->tpl_var['allright']; ?></b>道题，得到<b class="orange"><?php echo $this->tpl_var['sessionvars']['examsessionscore']; ?></b>分</td>
                          </tr>
                       </table>
