...
<div id="main">
	...
	<div id="right_760" class="right_760">
    	...
    	<div class="bor_mid">
            ...
            <form action="?exam-app-exampaper-score" id="form1" name="form1" method="post">
                ...
                <h5>总分：<span class="orange">100</span>分 合格分数线：<span class="orange"><?php echo $this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['passscore']; ?></span>分 考试时间：<span class="orange"><?php echo $this->tpl_var['sessionvars']['examsessiontime']; ?></span>分钟</h5>
                <?php $oid = 0; ?>
                <?php $qid = 0;
 ...
 $qnid++; ?>
                ...
                <div class="qu_content" onmouseover="this.className='qu_content_hover'" onmouseout="this.className='qu_content'">
                	<h3><?php echo $tid; ?>、<?php echo html_entity_decode($this->ev->stripSlashes( $question['question'])); ?></h3>
                    <ul>
                    ...
                    <div class="qu_option" onmouseover="this.className='qu_option_hover'" onmouseout="this.className='qu_option'">
                        <div class="float_r ml_10<?php if($this->tpl_var['sessionvars']['examsessionscorelist'][$question['questionid']] == $this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['questype'][$quest['questid']]['score']){ ?> answer_icon_r<?php } else { ?> answer_icon_w<?php } ?>"></div>
 ...
 $did++; ?>
                    ...
                    <div class="qu_option" onmouseover="this.className='qu_option_hover'" onmouseout="this.className='qu_option'">
    					<div class="float_r ml_10<?php if($this->tpl_var['sessionvars']['examsessionscorelist'][$data['questionid']] == $this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['questype'][$quest['questid']]['score']){ ?> answer_icon_r<?php } else { ?> answer_icon_w<?php } ?>"></div>
                        <?php if($quest['questsort']){ ?>
